<template>
  <div class="page">
    ...
    <div class="container">
      <h2 class="text-center">50 short articles totaling around 3000 words</h2>
      <div class="box-project-subtitle small">Environment & Nature</div>
          ...
          <div class="box-project box-width-3">
            <div class="box-project-media">
              <img
                ...
                src="images/home-06-360x345.jpg"
                alt=""
                width="360"
                height="345"
                loading="lazy"
        ...
        <div class="col-sm-6 col-md-4 wow fadeInUp" data-wow-delay=".1s">
          <div class="box-project box-width-3">
            <div class="box-project-media">
              <img
                class="box-project-img"
                src="images/home-07-360x345.jpg"
                alt=""
                width="360"
                height="345"
                loading="lazy"
            ...
            <h6 class="box-project-title">
              <router-link to="/single-course">Global housing design</router-link>
            </h6>
            <div class="box-project-meta">
              <div class="box-project-meta-item">
                <span class="box-project-meta-icon linearicons-clock3"></span>
                <span class="box-project-meta-text">34 hours</span>
              </div>
              <div class="box-project-meta-item">
                <span class="box-project-meta-icon linearicons-credit-card"></span>
                <span class="box-project-meta-text">$195</span>
              </div>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 wow fadeInUp" data-wow-delay=".2s">
          <div class="box-project box-width-3">
            <div class="box-project-media">
              <img
                class="box-project-img"
                src="images/home-08-360x345.jpg"
                alt=""
                width="360"
                height="345"
                loading="lazy"
            ...
            <h6 class="box-project-title">
              <router-link to="/single-course">IT fundamentals for business</router-link>
            </h6>
            <div class="box-project-meta">
              <div class="box-project-meta-item">
                <span class="box-project-meta-icon linearicons-clock3"></span>
                <span class="box-project-meta-text">8 hours</span>
              </div>
              <div class="box-project-meta-item">
                <span class="box-project-meta-icon linearicons-credit-card"></span>
                <span class="box-project-meta-text">$75</span>
              </div>
            </div>
          </div>
        </div>
...
.rd-navbar-wrap {
  /* ... your existing rd-navbar-wrap styles ... */
}

.rd-navbar {
  /* ... your existing rd-navbar styles ... */
}
