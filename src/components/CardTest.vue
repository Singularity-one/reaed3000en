...
export default {
  ...
  methods: {
    flipCard(index) {
      console.log("card.isFlipped", this.flashcards[index].isFlipped);
       console.log("card.word", this.flashcards[index].word);
              console.log("card.word", this.flashcards[index].definition);
